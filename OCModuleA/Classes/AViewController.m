...
#import <OCModuleB_Category/CTMediator+OCModuleB.h>
...
{
    UIViewController *viewController = [[CTMediator sharedInstance] OCModuleB_viewControllerWithContentText:@"hello, world!"];
